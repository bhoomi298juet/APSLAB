...
Original file is located at
    https://colab.research.google.com/drive/1-mfjiGlzzg3AGqEeSzfLzN4wA_DsNU_w
...
# Write a Function named as gcd_simple() that returns the GCD of two values (intuitive algorithm)
def gcd_simple(m, n):
    m = min(m, n)
    n = max(m, n)
